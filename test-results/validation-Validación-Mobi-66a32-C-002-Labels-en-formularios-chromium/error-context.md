...
- Name: validation.spec.ts >> Validación Mobile-First + Accesibilidad + Flujos >> AC-002: Labels en formularios
- Location: tests/validation.spec.ts:21:7
...
Locator: getByLabel(/Email|Correo/).or(getByLabel(/Contraseña/))
Expected: visible
Error: strict mode violation: getByLabel(/Email|Correo/).or(getByLabel(/Contraseña/)) resolved to 2 elements:
    1) <input value="" id="email" required="" type="email" placeholder="tu@email.com" class="w-full px-3 py-2 rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"/> aka getByRole('textbox', { name: 'Email' })
    2) <input value="" required="" id="password" type="password" placeholder="••••••••" class="w-full px-3 py-2 rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"/> aka getByRole('textbox', { name: 'Contraseña' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByLabel(/Email|Correo/).or(getByLabel(/Contraseña/))
  ...
  - main [ref=e11]:
    - generic [ref=e13]:
      - generic [ref=e14]:
        ...
        - paragraph [ref=e16]: Ingresá a tu cuenta de ElijoCreer
      - generic [ref=e17]:
        - generic [ref=e18]:
          - text: Email
