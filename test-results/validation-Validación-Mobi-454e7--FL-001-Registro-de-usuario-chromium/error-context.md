...
- Name: validation.spec.ts >> Validación Mobile-First + Accesibilidad + Flujos >> FL-001: Registro de usuario
- Location: tests/validation.spec.ts:48:7
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e11]:
    - generic [ref=e13]:
      - generic [ref=e14]:
        - heading "Crear Cuenta" [level=1] [ref=e15]
        - paragraph [ref=e16]: Únete a ElijoCreer y empezá a predecir
      - generic [ref=e17]:
        - generic [ref=e18]:
          - text: Nombre (opcional)
          - textbox "Nombre (opcional)" [ref=e19]:
      ...
      - paragraph [ref=e25]:
        ...
        - link "Iniciá Sesión" [ref=e26] [cursor=pointer]:
          - /url: /login
