...
- Name: validation.spec.ts >> Validación Mobile-First + Accesibilidad + Flujos >> EC-004: Loading state
- Location: tests/validation.spec.ts:130:7
...
- main:
  ...
  - paragraph: Ingresá a tu cuenta de ElijoCreer
  - text: Email
  - textbox "Email":
